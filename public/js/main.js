...
vue__WEBPACK_IMPORTED_MODULE_5__["default"].use(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), (axios__WEBPACK_IMPORTED_MODULE_4___default()));
...
var render = function () {
  ...
  return _c(
    ...
    {
      staticClass:
        "py-12 bg-gray-400 bg-opacity-80 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0",
      attrs: { id: "modal" },
    },
    [
      _c(
        "div",
        {
          staticClass: "container mx-auto w-11/12 md:w-2/3 max-w-lg",
          attrs: { role: "alert" },
        },
        [
          _c(
            ...
            {
              staticClass:
                "relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400",
            },
            [
              _c(
                "h1",
                  ...
                  _c(
                    ...
                    [
                      _c(
                        ...
                        {
                          staticClass:
                            "focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 bg-indigo-700 rounded text-white px-8 py-2 text-sm",
                          attrs: { type: "submit" },
                        },
                        [
                          _vm._v(
                      ...
                      _c(
                        ...
                        {
                          staticClass:
                            "focus:outline-none focus:ring-2 focus:ring-offset-2  focus:ring-gray-400 ml-3 bg-gray-100 transition duration-150 text-gray-600 ease-in-out hover:border-gray-400 hover:bg-gray-300 border rounded px-8 py-2 text-sm",
                          on: { click: _vm.closeTaskForm },
                        },
                        [_vm._v("Cancel")]
                      ),
                    ]
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("header", { staticClass: "py-4 px-8" }, [
      _c("h1", { staticClass: "text-3xl text-gray-800 text-center" }, [
        _vm._v("Kanban Board"),
      ]),
    ])
  },
